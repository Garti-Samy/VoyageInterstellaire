  ...
  return (
    <points ref={points} position={[0, 2, 0]} rotation={[0, 0, 0]} scale={0.4}>
      ...
      <shaderMaterial
        ...
        transparent={true}
        uniforms={{
          uInsideColor: { value: new THREE.Color('#ff6030') },
          uOutsideColor: { value: new THREE.Color('#1b3984') }
        }}
      />
    </points>
  );
...
// Exporter la Galaxy3d pour le composant IrregularGalaxie.jsx
export default Irregular3d;