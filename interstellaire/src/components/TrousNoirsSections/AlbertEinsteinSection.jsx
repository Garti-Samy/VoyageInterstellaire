...
//Importer la photo de profil d'Albert Einstein
import PicturePoincare from "../../assets/Albert.jpg"


// Function qui va afficher la citation et la mini biographie du mathématicien et scientifique : Albert Einstein
function AlbertEinsteinSection({ nom, citation, desOne, desTwo }) {

    // Balise alt de la photo d'Albert Einstein
    const altBalise = 'Photo de profil Albert Einstein'


    return <>
        {/* //Container parent */}
        <div className="sm:flex sm:gap-10">
            {/* // Biographie et citation, d'Albert Einstein */}
...
export default AlbertEinsteinSection