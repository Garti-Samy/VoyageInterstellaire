...
// Importer le hook de React THREE Fiber
...
const Spirale3d = () => {
  ...
  return (
    <points ref={points} position={[0, 2, 0]} rotation={[0, 0, 0]} scale={0.6}>
      <bufferGeometry>
        <bufferAttribute
      ...
      <shaderMaterial
        ...
        transparent={true}
        uniforms={{
          uInsideColor: { value: new THREE.Color('#E6007E') },
          uOutsideColor: { value: new THREE.Color('#006AFF') }
        }}
      />
    </points>
  );
...
// Exporter la Galaxy3d pour le composant SpiraleGalaxie.jsx
export default Spirale3d;